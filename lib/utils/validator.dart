...
class RequiredWithFlagValidator extends TextFieldValidator {
  bool flag;

  RequiredWithFlagValidator({required String errorText, required this.flag}) : super(errorText);
  ...
  @override
  bool isValid(String? value) {
    return flag || (value != null && value.isNotEmpty);
  }
...
class KTPValidator extends TextFieldValidator {


  KTPValidator({required String errorText}) : super(errorText);
  ...
  @override
  bool isValid(String? value) {
    return (value != null && value.isNotEmpty && value.length == 16);
  }
...
class RTRWValidator extends TextFieldValidator {


  RTRWValidator({required String errorText}) : super(errorText);
  ...
  @override
  bool isValid(String? value) {
    return (value != null && value.isNotEmpty && value.length == 7 && value.substring(3,4) == '/');
  }
